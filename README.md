...
- 👾 [Word Game Bench](https://github.com/zafstojano/wordgamebench?tab=readme-ov-file) – Evaluating LLMs on Wordle and Connections.
...
- 🌊 **"[Momentum-based Weight Interpolation for Continual Learning](https://arxiv.org/abs/2211.03186)." Interpolate @ <ins>NeurIPS</ins>** (Best Paper Award)
